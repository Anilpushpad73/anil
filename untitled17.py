...
Original file is located at
    https://colab.research.google.com/drive/1lOdrj6wPS0HyxB2FjUOQDIZDsq_7ZM5M
"""
...
def total_revenue(data: dict, financial_index: int) -> float:
    ...
    This function accesses the "pnl" (Profit and Loss) section in the data dictionary at the specified index.
    It retrieves the net revenue from the "lineItems" under "net_revenue".
